...
### 2. リポジトリチャネルの追加
python もOpenCV もバージョンアップが早く、かつバージョンの依存関係が複雑です。
チャネルの更新が一番早い conda-forge をチャネルに加えておきましょう。
...
3. Nameを適当につけ，Python 3.8 を選んで Create
4. Home > Jupyter Notebook > Install

### CUIで仮想環境作成
Anaconda Promptを起動して次のように打ち込んでください。
```
conda create -n RL python=3.8  opencv=4.5  jupyter jupyterlab matplotlib pillow openpyxl pandas
```
