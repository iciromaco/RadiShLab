...
class BezierCurve:
    ...
    # 段階的ベジエ近似
    def fit2(self, mode=0, Nprolog=3, Nfrom=5, Nto=12, preTry=200, maxTry=0, lr=0.0015, lrP=1140, pat=10, err_th=0.75, threstune=1.0, withErr=False, tpara=[], withFig=False):
